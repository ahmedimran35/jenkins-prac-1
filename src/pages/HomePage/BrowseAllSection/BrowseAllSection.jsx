...
const BrowseAllSection = () => {
  return (
    <div className="bg-black my-20">
      <div className="md:max-w-4xl lg:max-w-7xl mx-auto h-[500px] md:h-[400px] lg:h-[550px] flex flex-col-reverse md:flex-row justify-between items-center p-10">
        <div className="text-white max-w-xl flex flex-col justify-between items-start gap-5 lg:gap-10">
          ...
          <BASMainText />
          <PrimaryButton text="Browse All Category" />
        </div>
